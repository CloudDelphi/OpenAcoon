...
Changelog:
18-May-2008: MikeS: Modified: RobotsTxtStartCheckingFor now returns TRUE if
    it must start a GET-request for robots.txt. This is used by the robot to
    count new outgoing connections.
*)
